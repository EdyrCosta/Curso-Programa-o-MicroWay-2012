...
type
  TdmPrincipal = class(TDataModule)
    ...
    cdsEspecializacoesCODIGO_ESPECIALIZACAO: TFMTBCDField;
    cdsEspecializacoesNOME_ESPECIALIZACAO: TWideStringField;
    cdsEspecializacoesDESCRICAO_ESPECIALIZACAO: TWideStringField;

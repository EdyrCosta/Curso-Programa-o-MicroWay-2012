...
begin
  ...
  dmPrincipal.sqlRelConsultas.SQL.Add('oORDER BY DATA_CONSULTA');
  dmPrincipal.sqlRelConsultas.Open;

  dmPrincipal.RvPrjConsultorio.ExecuteReport('rptConsultas');
end;
